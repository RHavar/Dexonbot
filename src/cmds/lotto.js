module.exports = {
    ...
    exec: function(data){
        ...
        if(channelName == "english"){
            require("../bot.js").dexonbot.webClient.doSay("@"+username+" Please use another channel for that command. (Click on the flag at the bottom right of the chat)", channelName);
            return;
        }
