                ...
                timer: setInterval(function(){
                    if(require("../bot.js").lotto.users.length>0 && ((new Date()).getUTCMinutes() === 0 && require("../bot.js").lotto.canDraw || require("../bot.js").lotto.mustDraw)){
                        ...
                        if(!require("../bot.js").lotto.winner){
                            ...
                            require("../bot.js").dexonbot.webClient.doSay("[Lotto] @"+username+" won a prize! Type '!claim' in chat to claim your prize! (You have 120 seconds)", 'english');
                            ...
                            require("../bot.js").lotto.winner = {
                                ...
                                timeout: setTimeout(function() {
                                    ...
                                    require("../bot.js").dexonbot.webClient.doSay("[Lotto] @"+require("../bot.js").lotto.winner.username+" didn't claim in time and missed the lotto.", 'english');
                                    require("../bot.js").lotto.users = [];
                                    require("../bot.js").lotto.cashout = getRandomInt(1, 15);
                                    require("../bot.js").lotto.pot += 10;
                                    require("../bot.js").dexonbot.webClient.doSay("[Lotto] To participate to the next lotto, you must now cashout over: "+require("../bot.js").lotto.cashout+".00x  (Type '!lotto' in chat for more details)", 'english');
